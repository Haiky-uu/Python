...
# with open(r'C:\PythonWork\Data\yaml_simple.yaml') as f:
# with open('C:\PythonWork\Data\yaml_lists.yaml') as f:
# with open('C:\PythonWork\Data\yaml_dict.yaml') as f:
with open(r'C:\PythonWork\Data\nested_yaml_dict.yaml') as f:
